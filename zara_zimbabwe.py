...
# SALE PRODUCTS #
# Getting started
sale_link = 'https://www.zara.com/ww/en/sale-l879.html?v1=643501'
regular_link = 'https://www.zara.com/ww/en/new-collection-l1580.html?v1=1163368'
results = ''
currency = ' EUR'
exchange_rate = 4.2903
country = 'Zimbabwe'
...
file = open(os.path.expanduser('zara_zimbabwe.csv'), 'wb')
